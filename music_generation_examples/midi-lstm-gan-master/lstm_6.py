...
class ModelCheckpoint_GenerateData(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if self.epochs_since_last_save >= self.period:
            ...
            #file_name = './midi_bts_6_lstm_output/bts_' + str(n_epochs)
...
def train_network():
    ...
    mc_gd = ModelCheckpoint_GenerateData('./midi_bts_6_lstm_output/bts_6_lstm_{epoch:08d}', \
    ...
    model.save('./midi_bts_6_lstm_output/LSTMmodel.h5')
    ...
    plt.savefig('./midi_bts_6_lstm_output/LSTM_Loss_per_Epoch.png')
    plt.close()
...
def get_notes():
    ...
    for file in glob.glob("midi_bts_6/*.mid"):
