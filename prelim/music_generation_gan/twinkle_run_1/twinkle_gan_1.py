...
def get_notes():
    ...
    notes = []
    for file in glob.glob("./twinkle_data/*.mid"):
...
class GAN():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % save_interval == 0:
                ...
                model_name = './twinkle_models/twinkle_' + str(epoch)
    ...
    def generate(self, input_notes, epoch):
        ...
        file_name = './twinkle_output/twinkle_' + str(epoch)
    ...
    def plot_loss(self):
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Loss')
        plt.savefig('./twinkle_output/GAN_Loss_per_Epoch_final.png', transparent=True)
        plt.close()
