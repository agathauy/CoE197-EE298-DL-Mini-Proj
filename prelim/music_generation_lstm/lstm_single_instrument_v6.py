...
def train_network(out_folder, in_folder, n_epochs=50):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', type=str, help='Input dir of midi files')
    parser.add_argument('-o', type=str, help='Output dir of midi files')
    parser.add_argument('-e', type=int, help='Number of epochs to train. Min. 10.', default=100)
    ...
    train_network(OUTPUT_FOLDER, INPUT_FOLDER, num_epochs)
    end_time = time.time()
